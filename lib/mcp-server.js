...
import {buildTreeText, extractSymbols, filterReferences, runRipgrep} from './mcp-tools.js'
...
export async function startMcpServer() {
  ...
  // Ensure we exit if the transport (stdin) closes
  ...
  transport.close = async () => {
    ...
    if (originalClose) {
      await originalClose.call(transport)
    }
  }
